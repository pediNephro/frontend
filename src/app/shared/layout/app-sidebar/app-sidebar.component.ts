  ...
  navItems: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { name: "Vital Signs Trends", path: "/vital-signs/trends" },
        { name: "Patient Alerts", path: "/patient-alerts" },
        { name: "Alert Thresholds", path: "/thresholds" },
        { name: "Growth Charts", path: "/growth-charts" },
        { name: "Growth Curve", path: "/growth-charts/curve" },
        { name: "Medical Notes", path: "/medical-notes" },
        { name: "Renal Functions", path: "/renal-functions" },
      ],
    },
    {
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z" fill="currentColor"/><circle cx="12" cy="9.5" r="1.5" fill="currentColor"/></svg>`,
      name: "Transplant",
      subItems: [
