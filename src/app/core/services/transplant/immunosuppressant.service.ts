...
export class ImmunosuppressantService {
  private apiUrl = `${environment.transplantApiUrl}/api/drugs`;

  constructor(private http: HttpClient) {}

  // CRUD
  create(immunosuppressant: ImmunosuppressantDTO): Observable<Immunosuppressant> {
    return this.http.post<Immunosuppressant>(`${this.apiUrl}/transplant/${immunosuppressant.transplantId}`, immunosuppressant);
  }
